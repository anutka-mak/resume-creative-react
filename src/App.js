...
function App() {
  return (
  <div class="resume animation-text">
    <header class="header">
      <h1 class="name">Ann Makiichuk</h1>
      <p class="header__description">Student CHDTU | A beginner in programming</p>
    </header>
    <div class="star">★</div>
    ...
    <section class="photo">
      <div class="image-container">
        <img class="image" src="photo.jpg" alt="My photo" />
      </div>
    </section>
    <section class="about">
    ...
    <section class="experience">
      ...
      <div class="experience-item show-section">
